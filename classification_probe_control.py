...
training_inputs = make_dataset(exactly_zero, quant_mapping, 1000, 1000)
training_dataset = extract_hidden_states_and_labels(exactly_three_decider, training_inputs, exactly_zero_ABs)
validation_inputs = make_dataset(exactly_zero, quant_mapping, 100, 100)
validation_dataset = extract_hidden_states_and_labels(exactly_three_decider, validation_inputs, exactly_zero_ABs)
